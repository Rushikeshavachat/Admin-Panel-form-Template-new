...
var GoogleSignInButton = function () {
    ...
    return (react_1["default"].createElement("button", { className: "flex items-center justify-center gap-7 bg-black text-white px-6 py-6 rounded-lg overflow-hidden max-h-screen  ", onClick: signInWithGoogle },
